...
MAKEFILE = meanShiftLABXY_mex.mk

include meanShiftLABXY_mex.mki


SRC_FILES =  \
	meanShiftLABXY_data.c \
	meanShiftLABXY_initialize.c \
	meanShiftLABXY_terminate.c \
	meanShiftLABXY.c \
	eml_int_forloop_overflow_check.c \
	_coder_meanShiftLABXY_info.c \
	_coder_meanShiftLABXY_api.c \
	_coder_meanShiftLABXY_mex.c \
	meanShiftLABXY_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = meanShiftLABXY_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/meanShiftLABXY"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/meanShiftLABXY/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/meanShiftLABXY/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/meanShiftLABXY/%.cu
	$(CC) $(CCFLAGS) "$<"
