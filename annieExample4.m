...
[pts_8_8,xy,cs,clusters_8_8] = meanShiftSegment5(data,bw,options);
pts_8_8  = lab2rgb(pts_8_8);
disp('done with 8_8');

bw = [8,16,30]; %first is colors, 2nd is space
[pts_16_8,xy,cs,clusters_16_8] = meanShiftSegment5(data,bw,options);
pts_16_8  = lab2rgb(pts_16_8);
disp('done with 16_8');

bw = [8,32,30]; %first is colors, 2nd is space
[pts_32_8,xy,cs,clusters_32_8] = meanShiftSegment5(data,bw,options);
pts_32_8  = lab2rgb(pts_32_8);
disp('done with 32_8');

bw = [4,16,30]; %first is colors, 2nd is space
[pts_16_4,xy,cs,clusters_16_4] = meanShiftSegment5(data,bw,options);
pts_16_4  = lab2rgb(pts_16_4);
disp('done with 16_4');

bw = [4,32,30]; %first is colors, 2nd is space
[pts_32_4,xy,cs,clusters_32_4] = meanShiftSegment5(data,bw,options);
pts_32_4  = lab2rgb(pts_32_4);
disp('done with 32_4');

bw = [16,8,30]; %first is colors, 2nd is space
[pts_8_16,xy,cs,clusters_8_16] = meanShiftSegment5(data,bw,options);
pts_8_16  = lab2rgb(pts_8_16);
disp('done with 8_16');

bw = [16,16,30]; %first is colors, 2nd is space
[pts_16_16,xy,cs,clusters_16_16] = meanShiftSegment5(data,bw,options);
pts_16_16  = lab2rgb(pts_16_16);
disp('done with 16_16');

bw = [16,32,30]; %first is colors, 2nd is space
[pts_32_16,xy,cs,clusters_32_16] = meanShiftSegment5(data,bw,options);
