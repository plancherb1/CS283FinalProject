 ...
 *
 * _coder_meanShiftLAB_api.c
 *
 * Code generation for function '_coder_meanShiftLAB_api'
 *
 */
...
static real_T c_emlrt_marshallIn(const emlrtStack *sp, const mxArray *bandwidth,
...
void meanShiftLAB_api(const mxArray * const prhs[4], const mxArray *plhs[1])
{
  emxArray_real_T *X;
  ...
  bandwidth = c_emlrt_marshallIn(&st, emlrtAliasP(prhs[2]), "bandwidth");
  e_emlrt_marshallIn(&st, emlrtAlias(prhs[3]), "activeIndicies", activeIndicies);

  /* Invoke the target function */
  meanShiftLAB(&st, X, currX, bandwidth, activeIndicies, newX);
...
/* End of code generation (_coder_meanShiftLAB_api.c) */
