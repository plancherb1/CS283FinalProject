...
MAKEFILE = meanShiftLAB_mex.mk

include meanShiftLAB_mex.mki


SRC_FILES =  \
	meanShiftLAB_data.c \
	meanShiftLAB_initialize.c \
	...
	meanShiftLAB_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = meanShiftLAB_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/meanShiftLAB"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/meanShiftLAB/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/meanShiftLAB/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/meanShiftLAB/%.cu
	$(CC) $(CCFLAGS) "$<"
