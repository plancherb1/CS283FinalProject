START_DIR = /home/brian/Desktop/Final\ Project/src

MATLAB_ROOT = /usr/local/MATLAB/R2017a
MAKEFILE = meanShiftSegmentLABXY_mex.mk

include meanShiftSegmentLABXY_mex.mki


SRC_FILES =  \
	meanShiftSegmentLABXY_data.c \
	...
	cat.c \
	sum.c \
	_coder_meanShiftSegmentLABXY_info.c \
	_coder_meanShiftSegmentLABXY_api.c \
	_coder_meanShiftSegmentLABXY_mex.c \
	meanShiftSegmentLABXY_emxutil.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = meanShiftSegmentLABXY_mex
...
SYS_INCLUDE += -I "$(START_DIR)/codegen/mex/meanShiftSegmentLABXY"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/meanShiftSegmentLABXY/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/meanShiftSegmentLABXY/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)/codegen/mex/meanShiftSegmentLABXY/%.cu
	$(CC) $(CCFLAGS) "$<"
